...
- 场景自然贴合事件性质（议事堂、党部、办公室、媒体现场、私密空间等任选），每次选最契合当前事件的发生地，避免固定套路
...
- 派阀命名必须使用虚构名称（如：至诚会、创志会、新政会等）使用简体中文
- 媒体报道必须使用固定的三家媒体：
  * 中央时事新闻（中间派立场）
  * 革新民报（左翼立场）
  * 经合新闻（右翼立场）
...
### 政治晋升体系（双轨制，Phase G Q2）
- 党内路线（8 级）：普通党员→党务干部→政策委员会委员→政策委员会委员长→副干事长→干事长→副党首→党首
- 党派别名：ULP 用"主席/副主席/书记局长/副书记/组织局干部"；改革/保守党用"政调会长"替代政策委员会委员长
...
### 政治资本系统（Phase G Q3）
- 议员个人 politicalCapital (0-100, 初始 30)
